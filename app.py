...
<html lang="en">
<head><meta charset=utf-8><title>OEC Demo</title><meta http-equiv="Refresh" content="0; url='/ui/'" /></head>
<body><h1>OEC Demo</h1><p><a href="/ui/">DataExplorer</a></p><p style="opacity:0.5">{commit_hash}</p></body>
</html>
"""
